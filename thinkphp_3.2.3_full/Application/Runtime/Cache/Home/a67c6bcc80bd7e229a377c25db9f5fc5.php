...
<table width="60%" height="" border="0" align="center">
  <tr width="12%" bgcolor="#CCCCCC">
    ...
    <th width="12%" scope="col" >全名</th>
    <th width="12%" scope="col">用户id</th>
    <th width="12%" scope="col">ip地址</th>
    <th width="12%" scope="col">登陆时间</th>
  ...
  <tr style="text-align: center;" bgcolor="<?php echo $i%2==0?'#CCCCCC':''; ?>">
    ...
    <td><?php echo date("Y-m-d h:i:sa", $arr['up_date']); ?></td>
	<td>
	<a href='<?php echo PUB; ?>Home/Log/addLog/id/<?php echo $arr['id']; ?>'>
